#############################################################################
# Makefile for building: DE_Assignment
# Generated by qmake (3.1) (Qt 5.13.0)
# Project:  DE_Assignment.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile DE_Assignment.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = DE_Assignment1.0.0
DISTDIR = /home/anton/DE_Assignment/.tmp/DE_Assignment1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
LIBS          = $(SUBLIBS) /usr/lib/libQt5Charts.so /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so /usr/lib/libGL.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
SOURCES       = chart.cpp \
		...
		modelbuilder.cpp \
		numericalsolver.cpp \
		rksolver.cpp moc_mainwindow.cpp
OBJECTS       = chart.o \
		chartview.o \
		errorfinder.o \
		eulersolver.o \
		exactsolver.o \
		improvedeulersolver.o \
		main.o \
		mainwindow.o \
		modelbuilder.o \
		numericalsolver.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		numericalsolver.cpp \
		rksolver.cpp
QMAKE_TARGET  = DE_Assignment
DESTDIR       = 
TARGET        = DE_Assignment


first: all
####### Build rules

DE_Assignment: ui_mainwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: DE_Assignment.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		DE_Assignment.pro
	$(QMAKE) -o Makefile DE_Assignment.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents chart.h chartview.h errorfinder.h eulersolver.h exactsolver.h improvedeulersolver.h mainwindow.h modelbuilder.h numericalsolver.h rksolver.h $(DISTDIR)/
	$(COPY_FILE) --parents chart.cpp chartview.cpp errorfinder.cpp eulersolver.cpp exactsolver.cpp improvedeulersolver.cpp main.cpp mainwindow.cpp modelbuilder.cpp numericalsolver.cpp rksolver.cpp $(DISTDIR)/
...
moc_mainwindow.cpp: mainwindow.h \
		...
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include /home/anton/DE_Assignment/moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/anton/DE_Assignment -I/usr/include/qt -I/usr/include/qt/QtCharts -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/9.1.0 -I/usr/include/c++/9.1.0/x86_64-pc-linux-gnu -I/usr/include/c++/9.1.0/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.1.0/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/9.1.0/include-fixed -I/usr/include mainwindow.h -o moc_mainwindow.cpp
...
errorfinder.o: errorfinder.cpp errorfinder.h \
		numericalsolver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o errorfinder.o errorfinder.cpp

eulersolver.o: eulersolver.cpp eulersolver.h \
		numericalsolver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o eulersolver.o eulersolver.cpp

exactsolver.o: exactsolver.cpp exactsolver.h \
		numericalsolver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o exactsolver.o exactsolver.cpp

improvedeulersolver.o: improvedeulersolver.cpp improvedeulersolver.h \
		numericalsolver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o improvedeulersolver.o improvedeulersolver.cpp
...
modelbuilder.o: modelbuilder.cpp modelbuilder.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o modelbuilder.o modelbuilder.cpp

numericalsolver.o: numericalsolver.cpp numericalsolver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o numericalsolver.o numericalsolver.cpp

rksolver.o: rksolver.cpp rksolver.h \
		numericalsolver.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o rksolver.o rksolver.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/DE_Assignment/bin || mkdir -p $(INSTALL_ROOT)/opt/DE_Assignment/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/DE_Assignment/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/DE_Assignment/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/DE_Assignment/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/DE_Assignment/bin/ 
